...
@testset "process_ASTs" begin
    ...
    result = process_ASTs(Table(in=inmags, out=outmags,
                                flag=goodflag), :in, :out, bins, x->x.flag==true)
