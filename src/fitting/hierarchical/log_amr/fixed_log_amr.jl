...
"
    (α, β) = _calculate_αβ_logamr(low_constraint, high_constraint, Z_func=Z_from_MH)
...
"
function _calculate_αβ_logamr(low_constraint, high_constraint, Z_func=Z_from_MH)
...
function fixed_log_amr(models, data, logAge, metallicities, low_constraint, high_constraint, σ; Z_func=Z_from_MH, kws...)
    α, β = _calculate_αβ_logamr(low_constraint, high_constraint, Z_func)
