...
The gradient of the objective with respect to the ``r_{j,k}`` is given by Equation 21 in [Dolphin2002](@cite) as shown in the [section on linear AMRs](@ref linear_amr_section),
